...
\Author[1]{Jes\'us Isaac}{Castillo-S\'anchez}

\affil[1]{Universidad Aut\'onoma Chapingo, Texcoco, M\'exico}


\runningauthor{Castillo-Sánchez}

\runningtitle{CrossDomain Gap Analysis for Regional Climate Prediction}

\correspondence{Jes\'us Isaac Castillo-S\'anchez (jcastillos@chapingo.mx)}
...
physics-informed machine learning~\citep{Raissi2019, LeCun2015}, and regional climatology of Mexico.
...
While Nash equilibrium appears extensively in climate diplomacy (20 papers;~\citep{Forgo2005})
and carbon markets (11 papers;~\citep{Haurie2004}), it has never been applied as a physical
principle governing competing atmospheric mass dynamics. Similarly,
stochastic primitive equations exist mathematically~\citep{Debussche2012, Guo2021} \citep{Debussche2012, Majda2006} but without Nash solutions or formal verification.
...
\noindent\textbf{Code availability:} DOI: 10.5281/zenodo.20942657
\end{abstract}
...
Lean4 to any physical or climate model. This false-positive detection
...
as strategic games~\citep{DeCanio2013, Forgo2005, Breton2003, Long2018}; (2)~economic — 11
papers on carbon markets, emission permit allocation~\citep{Haurie2004}, and low-carbon
...
which mentions verification in passing~\citep{Combustion2026}. No climate model has been
formally verified in Lean4 or any other theorem prover.

\begin{table}[ht]
\centering
\caption{Thematic classification of the 187-article corpus by domain.
Papers may belong to more than one category; counts reflect primary
thematic focus. 92 papers fall outside these categories (general
climate modeling, hydrology, and other topics not shown).
The Super-Gap (Nash + EDE + Lean4) contains zero papers in Scopus (June 2026).}
\label{tab:thematic}
\small
\begin{tabular}{lrrr}
\hline
...
advanced the understanding of complex competitive systems~\citep{Ghil2002}, yet have never
been applied jointly to atmospheric dynamics:

\textbf{Nash equilibrium} from non-cooperative game theory~\citep{Osborne1994, Fudenberg1991} provides a
...
convection, and mesoscale variability act as stochastic forcing~\citep{Frankignoul2012}.
...
Lean4~\citep{LeanFour2021, Mathlib2020} provides machine-checked proofs of mathematical
...
This prediction is testable with existing ERA5 reanalysis data~\citep{Hersbach2020, Beck2020} and
...
Formal proofs of these propositions in Lean4 constitute Art.C3 of the
research agenda.
...
\textbf{Art.C3}: Lean4 formal verification of NECM Propositions 1--3.
...
network and ERA5 reanalysis~\citep{Hersbach2020, Munoz2021} over Mexico, 1980--2025.
...
The SCIFLOW-CLIMA-MX code, manuscript, figures, and data files
are publicly available at:

\begin{itemize}
\item GitHub: \url{https://github.com/isaakcastillo/sciflow-clima-mx}
\item Zenodo: \url{https://zenodo.org/records/20942657} (DOI: 10.5281/zenodo.20942657)
\end{itemize}

ERA5 climate data were retrieved via the Open-Meteo API
(\url{https://open-meteo.com}), which provides free access to
ERA5 reanalysis data~\citep{Hersbach2020}.
Scopus literature data were retrieved via the Elsevier Scopus API
under institutional access at Universidad Autónoma Chapingo.
All retrieved data are included in the repository.

The SCIFLOW platform is registered under INDAUTOR (Mexican
Institute of Intellectual Property), registration 2026,
...
J.I. Castillo-Sánchez: Conceptualization, Methodology, Software,
...
\authorcontribution{J.I. Castillo-Sánchez: Conceptualization, Methodology,
Software, Formal Analysis, Investigation, Data Curation,
Writing (original draft, review and editing), Visualization.}

\competinginterests{The author declares no competing interests.}

\begin{acknowledgements}
The author thanks Universidad Autónoma Chapingo for institutional support.
ERA5 data were obtained via the Open-Meteo API (open-meteo.com).
SCIFLOW is registered under INDAUTOR, México, 2026.
